...
public class CsrfDevModeTest {
    ...
    public void testCsrfConfigChange() {
        ...
        // expect random bytes to be 32 as we configured 'quarkus.rest-csrf.token-size=32'
        assertTokenSize(token, 32);
        // then encoded random bytes may be greater than 32, but this test makes only sense if they are lesser than 64
