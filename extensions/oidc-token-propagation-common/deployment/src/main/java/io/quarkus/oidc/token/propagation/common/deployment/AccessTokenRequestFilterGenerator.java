                ...
                i -> {
                    ...
                    try (ClassCreator classCreator = ClassCreator.builder()
                        ...
                        if (i.targetMethodInfo != null) {
                            var methodDescriptionCtor = MethodDescriptor.ofConstructor(MethodDescription.class, String.class,
                            ...
                            try (var methodCreator = classCreator.getMethodCreator("getMethodDescription",
                                ...
                                var newMethodDescription = methodCreator.invokeSpecialMethod(methodDescriptionCtor,
                                        methodCreator.getThis(), declaringClassName, methodName, paramTypes);
                                // return new MethodDescription(declaringClassName, methodName, parameterTypes);
