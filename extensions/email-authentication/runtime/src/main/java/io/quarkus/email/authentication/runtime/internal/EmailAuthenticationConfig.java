...
interface EmailAuthenticationConfig {
    ...
    /**
     * Path of the page where email authentication token should be posted in order to receive credentials
     * (session cookie). The token should be submitted as a form parameter with name {@link #tokenParameter()}.
     */
    ...
    /**
     * The email authentication token field name.
     */
    @WithDefault("j_token")
    String tokenParameter();

    /**
     * The generated email authentication token length.
     */
    @WithDefault("15")
    int tokenLength();

    /**
     * Path of the page where {@link #usernameParameter()} should be posted in order to request the email authentication token.
     */
    ...
    /**
     * Name of the mailer used to send email authentication tokens.
