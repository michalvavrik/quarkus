                    ...
                    .addAsResource(
                            new StringAsset(
                                    """
                                            ...
                                            quarkus.oidc.tenant-a.token.resolve-tenant-with-header=true
                                            ...
                                            quarkus.oidc.tenant-b.token.resolve-tenant-with-header=true
                                            quarkus.keycloak.devservices.enabled=false
                                            """),
                            "application.properties"));

    @Test
    void testTenantAResolved() {
        assertTenantResolverForHeader("Custom-Authorization-1", "tenant-a");
    }

    @Test
    void testTenantBResolved() {
