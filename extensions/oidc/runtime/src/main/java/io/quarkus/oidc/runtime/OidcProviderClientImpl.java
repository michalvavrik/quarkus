...
public class OidcProviderClientImpl implements OidcProviderClient, Closeable {
    ...
    final Uni<String> doPushedAuthorizationRequest(String codeFlowParams) {
        ...
        return getHttpResponse(requestProps, metadata.getPushedAuthorizationRequestUri(),
                ...
                .transformToUni(resp -> getJsonObject(requestProps, metadata.getPushedAuthorizationRequestUri(), resp,
