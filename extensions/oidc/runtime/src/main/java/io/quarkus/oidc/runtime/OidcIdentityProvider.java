...
import io.quarkus.oidc.DPoPNonceProvider.DPoPProofContext;
                    ...
                    result = result.onItem().transform(new Function<TokenVerificationResult, TokenVerificationResult>() {
                        ...
                        public TokenVerificationResult apply(TokenVerificationResult t) {
                            ...
                            if (dPoPNonceProvider != null) {
                                ...
                                DPoPProofContext proofContext = new DPoPProofContext(proofNonce,
                                        proofClaims.getString(OidcUtils.DPOP_JWT_ID),
