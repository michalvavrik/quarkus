    ...
    public static class Authentication implements io.quarkus.oidc.runtime.OidcTenantConfig.Authentication {
        ...
        public RichAuthorizationRequests rar() {
            return new RichAuthorizationRequests() {
                @Override
                public Map<String, String> simpleType() {
                    return rarSimpleAuthorizationDetails;
                }

                @Override
                public Map<String, List<String>> arrayType() {
                    return rarArrayAuthorizationDetails;
                }
            };
        }
        ...
        private Map<String, String> rarSimpleAuthorizationDetails = Map.of();
        private Map<String, List<String>> rarArrayAuthorizationDetails = Map.of();
        ...
        private void addConfigMappingValues(io.quarkus.oidc.runtime.OidcTenantConfig.Authentication mapping) {
            ...
            rarSimpleAuthorizationDetails = mapping.rar().simpleType();
            rarArrayAuthorizationDetails = mapping.rar().arrayType();
        }
    }
