...
public final class AuthenticationConfigBuilder {
     ...
     * request parameter.
     *
     * @param authorizationDetails {@link RichAuthorizationRequests#authorizationDetails()}
     * @return this builder
     */
    public AuthenticationConfigBuilder rar(Map<String, String> authorizationDetails) {
        if (authorizationDetails != null && !authorizationDetails.isEmpty()) {
            record RichAuthorizationRequestsImpl(Map<String, String> authorizationDetails)
                    implements
                        RichAuthorizationRequests {
            }
            this.rar = new RichAuthorizationRequestsImpl(Map.copyOf(authorizationDetails));
        }
        return this;
    }
