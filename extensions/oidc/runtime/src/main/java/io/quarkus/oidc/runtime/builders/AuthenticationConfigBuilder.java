...
public final class AuthenticationConfigBuilder {
     ...
     *
     * @param endpoint {@link PushedAuthorizationRequest#endpoint()}
     * @return this builder
     */
    public AuthenticationConfigBuilder par(String endpoint) {
        record PushedAuthorizationRequestImpl(Optional<Boolean> enabled,
                Optional<String> endpoint) implements PushedAuthorizationRequest {
        }
        this.par = new PushedAuthorizationRequestImpl(Optional.of(true), Optional.ofNullable(endpoint));
        return this;
    }
