...
public final class AuthenticationConfigBuilder {
     ...
     * request parameter.
     *
     * @param authorizationDetails {@link RichAuthorizationRequests#simpleType()}
     * @return this builder
     */
     ...
     * request parameter.
     *
     * @param simpleAuthorizationDetails {@link RichAuthorizationRequests#simpleType()}
    ...
    public AuthenticationConfigBuilder rar(Map<String, String> simpleAuthorizationDetails,
        ...
        record RichAuthorizationRequestsImpl(Map<String, String> simpleType, Map<String, List<String>> arrayType)
                implements
