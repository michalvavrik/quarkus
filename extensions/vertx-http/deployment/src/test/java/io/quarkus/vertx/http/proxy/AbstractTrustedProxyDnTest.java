...
abstract class AbstractTrustedProxyDnTest {
    ...
    static QuarkusExtensionTest createTest(String clientAuth, String trustedProxyDn) {
        final String configuration = """
                ...
                quarkus.http.proxy.trusted-proxy-dn=%4$s
                """.formatted(CERTS_DIR + CERT_NAME, PASSWORD, clientAuth, trustedProxyDn);
