...
class FormAuthRedirectQueryParamsTest {
    ...
    void testSingleQueryParamPassed() {
        testLoginPageQueryParamsOnly("/admin", Set.of("jfwid=1234"), Set.of(), Set.of());
        testLandingPageQueryParamsOnly(Set.of("jfwid=1234"), Set.of(), Set.of());
    }

    private static void testLandingPageQueryParamsOnly(Set<String> queryParams, Set<String> passedQueryParams,
    ...
    private static void testLoginPageQueryParamsOnly(String path, Set<String> queryParams, Set<String> passedQueryParams,
            Set<String> ignoredQueryParams) {
