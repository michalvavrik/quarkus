...
public class PersistentLoginManager {
    ...
    void save(String value, RoutingContext context, String cookieName, RestoreResult restoreResult,
    ...
    private static void clear(RoutingContext ctx, String cookieName) {
    ...
    String getAndRemoveCookie(String cookieName, RoutingContext routingContext) {
