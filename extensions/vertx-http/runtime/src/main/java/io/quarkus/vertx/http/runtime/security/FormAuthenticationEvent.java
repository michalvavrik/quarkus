...
public final class FormAuthenticationEvent extends AbstractSecurityEvent {
    ...
    /**
     * Form event attribute added when Quarkus received a request to generate the authentication token.
     */
    ...
    public static final String AUTHENTICATION_TOKEN_REQUEST = "AUTHENTICATION_TOKEN";
    ...
    public enum FormEventType {
        ...
        FORM_LOGIN,
        /**
         * Event fired when Quarkus received the authentication token request.
         */
    ...
    static FormAuthenticationEvent createLoginEvent(SecurityIdentity identity, AuthenticationRequest authenticationRequest) {
        ...
        if (authenticationRequest instanceof UsernamePasswordAuthenticationRequest) {
            ...
            credentialsType = AUTHENTICATION_TOKEN_REQUEST;
        } else {
    ...
    static FormAuthenticationEvent createAuthenticationTokenEvent(SecurityIdentity identity, String requestedUsername,
            RoutingContext event) {
        return new FormAuthenticationEvent(identity, Map.of(FORM_CONTEXT,
                FormEventType.AUTHENTICATION_TOKEN.toString(), REQUEST_USERNAME, requestedUsername,
                HttpSecurityUtils.ROUTING_CONTEXT_ATTRIBUTE, event));
    }

    static FormAuthenticationEvent createAuthenticationTokenEvent(Throwable authenticationFailure, String requestedUsername,
            RoutingContext event) {
        return new FormAuthenticationEvent(null, Map.of(FORM_CONTEXT,
                FormEventType.AUTHENTICATION_TOKEN.toString(), AUTHENTICATION_FAILURE, authenticationFailure,
