...
public interface ProxyConfig {
    ...
    /**
     * Identify trusted proxies by their TLS client certificate Subject DN, truststore alias, or both.
    ...
    interface TrustedProxyConfig {
         ...
         * the components specified in this value.
         */
         ...
         */
        Optional<String> truststoreAlias();
    }
}
