...
final class CookieFormAuthenticationTokenStorage implements FormAuthenticationTokenStorage {
    ...
    CookieFormAuthenticationTokenStorage(PersistentLoginManager loginManager, String cookieName) {
        this.loginManager = loginManager;
        this.cookieName = cookieName;
    }

    @Override
    public void storeToken(char[] token, String principalName, RoutingContext routingContext) {
