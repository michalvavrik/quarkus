...
public interface SmallRyeJwtConfig {
     ...
     */
    @ConfigDocDefault("'true' if 'mp.jwt.decrypt.key.location' or 'mp.jwt.verify.publickey.location' location is set and the location doesn't refer to the filesystem or the classpath resource")
