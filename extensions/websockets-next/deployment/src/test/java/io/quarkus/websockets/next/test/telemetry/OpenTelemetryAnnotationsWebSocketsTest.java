...
public class OpenTelemetryAnnotationsWebSocketsTest {
    ...
    public void testServerEndpointTracesOnly() {
        ...
        assertEquals("How U Livin'",
                customBounceServerSpan.getAttributes().get(AttributeKey.stringKey("message-callback-param")));
    }
    ...
    public void testServerTracesWhenErrorOnMessage() {
        ...
        assertThat(getSpansByName(CUSTOM_SPAN_BOUNCE_ECHO, SpanKind.SERVER).toList())
                ...
                .allMatch(span -> {
                    var callbackParam = span.getAttributes().get(AttributeKey.stringKey("message-callback-param"));
    ...
    public static class OtelBounceEndpoint {
        ...
        @OnTextMessage
        public String serverEcho(@SpanAttribute("message-callback-param") String message) {
            if (prefixResponses) {
