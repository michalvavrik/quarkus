...
public class OpenTelemetryAnnotationsWebSocketsTest {
    ...
    public void testServerEndpointTracesOnly() {
        ...
        Assertions.assertThat(customNamespaceAttr).contains("OtelBounceEndpoint");
    }
    ...
    public void testClientAndServerEndpointTraces() throws InterruptedException {
        ...
        Assertions.assertThat(customNamespaceAttr).contains("OtelBounceClient");
    }
    ...
    public static class OtelBounceEndpoint {
        ...
        @OnTextMessage
        public String serverEcho(String message) {
            if (prefixResponses) {
