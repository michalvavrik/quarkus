...
public class OpenTelemetryAnnotationsWebSocketsTest {
    ...
    public void testSpanAttributeOnError() {
        ...
        assertEquals("error", onErrorSpan.getAttributes().get(AttributeKey.stringKey("code.function")));
        assertThat(onErrorSpan.getAttributes().get(AttributeKey.stringKey("code.namespace"))).contains("Endpoint");
