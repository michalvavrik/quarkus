...
public abstract class AbstractRevokedAccessTokenDevModeTest {
    ...
    void verifyNamedClientHasTokenRefreshedOn401(MyClientCategory myClientCategory) {
        RestAssured.given()
    ...
    void verifyDefaultClientHasTokenRefreshedOn401(MyClientCategory myClientCategory) {
        RestAssured.given()
                .body(myClientCategory)
                .post(MY_CLIENT_RESOURCE_PATH)
                .then().statusCode(200)
