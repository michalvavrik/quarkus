...
public interface IdentityProviderManagerBuilder {
     ...
     *        will be ignored
     * @param augmentors {@link SecurityIdentityAugmentor}s; if specified, globally configured {@link SecurityIdentityAugmentor}
     *        will be ignored
     * @return the new {@link IdentityProviderManager}
     */
    IdentityProviderManager build(Collection<IdentityProvider<?>> identityProviders,
            Collection<SecurityIdentityAugmentor> augmentors);
