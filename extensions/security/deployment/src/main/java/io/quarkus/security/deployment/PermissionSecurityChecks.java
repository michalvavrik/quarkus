...
interface PermissionSecurityChecks {
    ...
    final class PermissionSecurityChecksBuilder {
        ...
        PermissionSecurityChecksBuilder(IndexView index, PermissionsAllowedMetaAnnotationBuildItem metaAnnotationItem,
            ...
            this.index = index;
            var instances = getPermissionsAllowedInstances(metaAnnotationItem, securityTransformerHelper);
        ...
        private static ArrayList<AnnotationInstance> getPermissionsAllowedInstances(
            ...
            var instances = getPermissionsAllowedInstances(securityTransformerHelper);
        ...
        static ArrayList<AnnotationInstance> getPermissionsAllowedInstances(
                SecurityTransformerHelper securityTransformerHelper) {
            return new ArrayList<>(securityTransformerHelper.getAnnotationsWithRepeatable(PERMISSIONS_ALLOWED));
        }

        static PermissionsAllowedMetaAnnotationBuildItem movePermFromMetaAnnToMetaTarget(
                SecurityTransformerHelper securityTransformerHelper) {
            var permissionsAllowed = getPermissionsAllowedInstances(securityTransformerHelper)
                    .stream()
            ...
            var newInstances = permissionsAllowed
                    ...
                    .flatMap(instanceOnMetaAnn -> {
                        ...
                        return securityTransformerHelper.getAnnotations(metaAnnotationName).stream()
