...
public class IdentityProviderManagerBuilderTest {
    ...
    @Test
    void bothLocalAndGlobalProvidersAndAugmentors() {
    ...
    @Test
    void globalProviderAndLocalAugmentors() {
    ...
    private static class TestIdentityProvider<T extends AuthenticationRequest> implements IdentityProvider<T> {
