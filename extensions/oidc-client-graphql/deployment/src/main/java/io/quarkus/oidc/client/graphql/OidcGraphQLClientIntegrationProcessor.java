...
class OidcGraphQLClientIntegrationProcessor {
    ...
    private static final String TOKEN_PROVIDER_CLASS = "io.quarkus.oidc.client.graphql.runtime.AbstractGraphQLTokenProvider";
     ...
     * {@code
     * @ApplicationScoped
     * class AbstractGraphQLTokenProvider_OidcClient1 extends AbstractGraphQLTokenProvider {
     *     AbstractGraphQLTokenProvider_OidcClient1() {
     *         super("OidcClient1");
     *     }
     * }
     * }
    ...
    void generateGraphQLTokenProducers(GraphQLTokenProducerInfo graphQLTokenProducerInfo,
        ...
        graphQLTokenProducerInfo.oidcClientToTokenProducerBeanName.forEach((oidcClientName, generatedClassName) -> {
            ...
            gizmo.class_(generatedClassName, cc -> {
                ...
                cc.constructor(ctorCreator -> ctorCreator
                        .body(bc -> bc.invokeSpecial(ConstructorDesc.of(tokenProviderClassDesc, String.class), cc.this_(),
