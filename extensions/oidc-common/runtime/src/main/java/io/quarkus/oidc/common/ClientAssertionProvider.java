...
public interface ClientAssertionProvider {
    ...
    /**
     * Gets current client assertion. This method should not block. If the client assertion is retrieve with blocking IO
     * operation, we recommend to keep the assertion up to date with a periodic scheduled task.
     *
