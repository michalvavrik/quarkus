...
public class QuarkusSecurityTestExtension implements QuarkusTestBeforeEachCallback, QuarkusTestAfterEachCallback {
    ...
    private SecurityIdentity augment(SecurityIdentity identity, Annotation[] annotations, ArcContainer container) {
        ...
        Instance<QuarkusPermissionSecurityIdentityAugmentor> quarkusPermissionAugmentor = container
                .select(QuarkusPermissionSecurityIdentityAugmentor.class);
        if (quarkusPermissionAugmentor.isResolvable()) {
            ...
            augmentedIdentity = quarkusPermissionAugmentor.get().augment(augmentedIdentity, authenticationRequestContext,
