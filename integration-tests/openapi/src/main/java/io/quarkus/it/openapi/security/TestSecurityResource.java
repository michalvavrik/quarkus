...
public class TestSecurityResource {
    ...
    public static int REQUEST_TIMEOUT = 5;

    private volatile String incomingHeaderValue = null;
    ...
    public String reactiveRoutesWithDelayedResponse(@Context SecurityContext securityContext) throws InterruptedException {
        ...
        incomingHeaderValue = httpHeaders.getHeaderString(TEST_HEADER_NAME);
        return securityContext.getUserPrincipal().getName();
    }
    ...
    public String getTestHeader() {
        return TEST_HEADER_NAME + " header value was: " + incomingHeaderValue;
    }
