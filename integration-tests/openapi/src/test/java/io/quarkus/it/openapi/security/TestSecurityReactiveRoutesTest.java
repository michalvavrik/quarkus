...
public class TestSecurityReactiveRoutesTest {
    ...
    private static final String TEST_HEADER_VALUE = "hush-hush";
    ...
    @TestSecurity(user = "Martin", roles = "admin")
    @Test
    public void testCdiRequestActiveAfterTimeout() {
        int valueLesserThanDelay = TestSecurityResource.REQUEST_TIMEOUT - 3;
        ...
        RestAssured.given()
                ...
                .statusCode(200)
                .header("reactive-routes-filter", is("true"))
                .body(is(TEST_HEADER_NAME + " header value was: " + TEST_HEADER_VALUE));
    }
