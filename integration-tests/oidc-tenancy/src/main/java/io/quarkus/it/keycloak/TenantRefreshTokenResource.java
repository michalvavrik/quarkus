...
public class TenantRefreshTokenResource {
    ...
    private void assertCount(OidcProviderClientImpl client, int expectedCount) {
        int actualCount = client.getRefreshTokenRequestsCount();
