...
quarkus.http.auth.permission.admin-endpoint.paths=/admin
quarkus.http.auth.permission.admin-endpoint.policy=authenticated
quarkus.http.auth.permission.admin-endpoint.auth-mechanism=bearer,x509 <1>
quarkus.http.auth.permission.admin-endpoint.inclusive=true <2>
----
