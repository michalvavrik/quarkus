...
NOTE: If you know that neither static nor dynamic OIDC tenants will need to handle back-channel logout notifications, you can disable an HTTP route that accepts these notifications to avoid unnecessary overhead, see the <<allowed-routes>> section for more information.
...
NOTE: If you know that neither static nor dynamic OIDC tenants will need to provide protected resource metadata, you can disable an HTTP route that supports protected resource metadata requests to avoid unnecessary overhead, see the <<allowed-routes>> section for more information.
