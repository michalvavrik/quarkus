...
The `quarkus.oidc.dpop.proof-age` and `quarkus.oidc.dpop.lifespan-grace` properties can be used to configure the DPoP proof freshness validation:
...
|quarkus.oidc.dpop.proof-age | 5 minutes | Maximum acceptable age of DPoP proof
|quarkus.oidc.dpop.lifespan-grace | 0 | Grace period in seconds applied to DPoP proof age and expiry
|====
