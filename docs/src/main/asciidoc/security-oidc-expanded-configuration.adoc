...
This build-time property defines which OIDC routes tenants can use. Each route requires a dedicated HTTP handler; remove routes no tenant needs to avoid unnecessary overhead.

Supported values:

* `backchannel-logout` - allows tenants to configure <<back-channel-logout,back-channel logout>> properties
* `resource-metadata` - allows tenants to configure <<resource-metadata-properties,protected resource metadata>> properties
...
NOTE: If you know that neither static nor dynamic OIDC tenants will require back-channel logout, you can disable its registration to avoid unnecessary overhead, see <<allowed-routes-properties>> for more information.
...
NOTE: If you know that neither static nor dynamic OIDC tenants will require protected resource metadata, you can disable its registration to avoid unnecessary overhead, see <<allowed-routes-properties>> for more information.
