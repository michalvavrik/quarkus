...
TIP: The `OidcTestClient` can also be used to test xref:security-openid-connect-dev-services.adoc#dev-services-for-oidc[Dev Services for OIDC], in which case no configuration is necessary.
