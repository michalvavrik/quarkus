...
You can provide custom DPoP nonce provider by implementing the `io.quarkus.oidc.DPoPNonceProvider` interface as a CDI bean.

.Example custom DPoP nonce provider
[source, java]
----
