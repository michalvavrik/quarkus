...
REST Data with Panache will use the xref:security-authorize-web-endpoints-reference.adoc#standard-security-annotations[standard security annotations] that are defined on your resource interfaces:
