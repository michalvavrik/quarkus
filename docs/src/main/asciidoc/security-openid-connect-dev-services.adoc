...
Additionally, you can adjust the lifespans of the access token and SSO session with the `quarkus.keycloak.devservices.token-lifespan` property, which is set to 10 minutes by default.
